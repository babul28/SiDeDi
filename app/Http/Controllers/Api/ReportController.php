...
class ReportController extends Controller
{
    ...
    public function show(Classe $class)
    {
        ...
        $averageClassReport = [
            ...
            'valEkslusif' => $studentsCount == 0 ? 0 : $roundAvgEkslusif,
            'valIntoleran' => $studentsCount == 0 ? 0 : $roundAvgIntoleran,
            'valEkstream' => $studentsCount == 0 ? 0 : $roundAvgEkstream,
            'valKekerasan' => $studentsCount == 0 ? 0 : $roundAvgKekerasan,
        ];
